...
const AnotherCard = () => {
  ...
  <div className="flex items-center gap-6 bg-white p-6 rounded-2xl shadow-sm ">
    ...
    <div>
      <h3 className="text-xl font-semibold text-gray-800">Live Parcel Tracking</h3>
  ...
  <div className="flex items-center gap-6 bg-white p-6 rounded-2xl shadow-sm ">
    ...
    <div>
      <h3 className="text-xl font-semibold text-gray-800">100% Safe Delivery</h3>
      <p className="text-gray-600 mt-2 text-sm leading-relaxed">
  ...
  <div className="flex items-center gap-6 bg-white p-6 rounded-2xl shadow-sm ">
    ...
    <div>
      <h3 className="text-xl font-semibold text-gray-800">24/7 Call Center Support</h3>
      <p className="text-gray-600 mt-2 text-sm leading-relaxed">
